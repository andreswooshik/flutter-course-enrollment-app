  ...
  static List<Subject> getFirstYearSubjects() {
    return [
      ...
      Subject(
        ...
        instructor: 'Dr. Patricia Villanueva',
        units: 1,
        capacity: 50,
        enrolled: 35,
        type: SubjectType.minor,
      ...
      Subject(
        ...
        instructor: 'Coach Anna Bautista',
        units: 2,
        capacity: 40,
        enrolled: 32,
        type: SubjectType.minor,
